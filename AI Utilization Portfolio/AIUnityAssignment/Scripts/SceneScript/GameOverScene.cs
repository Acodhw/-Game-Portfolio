...
public class GameOverScene : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        restartBtn.onClick.AddListener(OnLoadUIOpened);
        restartBtn.onClick.AddListener(PlayUISound);

        titleBtn.onClick.AddListener(OnTitleClicked);
        titleBtn.onClick.AddListener(PlayUISound);
