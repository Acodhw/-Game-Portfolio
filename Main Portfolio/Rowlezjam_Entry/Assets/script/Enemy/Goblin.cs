...
public class Goblin : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        EnemyAnimator.SetBool("Walk", xInput != 0);
    ...
    IEnumerator Attack() {
        ...
        if (ShotOBJ != null)
        {
            ...
            ShotsEvent se = Instantiate(ShotOBJ, transform.position + Vector3.right * facingDirection * 0.7f, new Quaternion(0, 0, 0, 0)).GetComponent<ShotsEvent>();
            se.shotDirection = new Vector2(se.shotDirection.x * facingDirection, se.shotDirection.y);
            se.ShotObj();
